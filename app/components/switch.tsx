...
const colors = {
  ...
  plum: [
    '[--switch-bg-ring:var(--color-plum-600)]/90 [--switch-bg:var(--color-plum-500)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-plum-600)]/90 [--switch-shadow:var(--color-plum-900)]/20',
  ],
};
