        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="bg-white dark:bg-black border-[3px] border-black dark:border-white rounded-[24px] p-12 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] dark:shadow-[12px_12px_0px_0px_rgba(255,255,255,1)]">
            ...
            <div className="text-center mb-10">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-white dark:bg-black rounded-full border-[3px] border-black dark:border-white mb-6">
                <svg
              ...
              <h1 className="text-5xl font-black mb-4">Payment Cancelled</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/checkout"
                className="flex-1 text-center px-8 py-4 bg-plum hover:bg-plum-dark text-white dark:text-black rounded-full font-bold border-[3px] border-black dark:border-white transition-all hover:translate-y-[-2px] text-lg"
              >
                Try Again →
              </Link>
              <Link
                to="/"
                className="flex-1 text-center px-8 py-4 bg-white dark:bg-black border-[3px] border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black rounded-full font-bold transition-all hover:translate-y-[-2px] text-lg"
              >
                Back to Home
              </Link>
            </div>
