        ...
        <div className="relative container mx-auto px-6 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm mb-8 border border-white/20">
              ...
              <span className="text-gray-300">Now with 6 framework exports</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              The first plugin that perfectly extracts your prototype animations. 
              Ship pixel-perfect motion in seconds, not hours.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-400 text-sm">Animations fail without proper tooling</p>
            </div>
            <div>
              <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">
                4hrs
              </div>
              <p className="text-gray-400 text-sm">Average time saved per project</p>
            </div>
            <div>
              <div className="text-4xl font-bold bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text text-transparent mb-2">
                1,034%
              </div>
              <p className="text-gray-400 text-sm">ROI on first animation export</p>
            </div>
            <div>
              <div className="text-4xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent mb-2">
                30sec
              </div>
              <p className="text-gray-400 text-sm">From Figma to production code</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="relative">
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
                ...
                <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
                  ...
                  <span className="ml-4 text-xs text-gray-500">AnimatedCard.tsx</span>
                </div>
    ...
    >
      Your content here
            ...
            <div className="flex flex-wrap gap-3 justify-center mt-8">
              {['CSS', 'React', 'Vue 3', 'Vanilla JS', 'Framer Motion', 'React Spring'].map((framework) => (
                <span key={framework} className="px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full text-sm border border-white/10">
                  {framework}
                </span>
              ))}
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16 text-center p-8 bg-gradient-to-r from-green-900/20 to-emerald-900/20 rounded-2xl border border-green-500/20 max-w-2xl mx-auto">
            ...
            <p className="text-2xl font-bold mb-2">
              Save 4 hours × $75/hour = <span className="text-green-400">$300 saved</span>
            </p>
            <p className="text-lg text-gray-400">
              That's a <span className="text-green-400 font-bold">1,034% return</span> on your first project
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm">
                The first Figma plugin for exporting animations to production-ready code.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://www.figma.com/community/plugin/motion-export" className="text-gray-400 hover:text-white transition-colors">
                    Figma Plugin
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://discord.gg/motionexport" className="text-gray-400 hover:text-white transition-colors">
                    Discord
                  </a>
                </li>
                <li>
                  <a href="https://github.com/animate-dev/motion-export" className="text-gray-400 hover:text-white transition-colors">
                    GitHub
                  </a>
                </li>
                <li>
                  <a href="https://twitter.com/motionexport" className="text-gray-400 hover:text-white transition-colors">
                    Twitter
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="mailto:support@motionexport.com" className="text-gray-400 hover:text-white transition-colors">
                    Email
                  </a>
                </li>
                <li>
